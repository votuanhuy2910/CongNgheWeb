<footer class="footer">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-4 col-xs-6 col-ssm">
          <div class="footer-widget">
            ...
            <div class="widget-content">
              ...
              <p><b><i class="fas fa-envelope"></i> Email:</b> <a href="mailto:phone2h2k@gmail.com" rel="nofollow">phone2h2k@gmail.com</a></p>
              <p><b><i class="fas fa-store-alt"></i> Địa chỉ:</b> 280 An Dương Vương, TP. Hồ Chí Minh</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-3 col-sm-4 hidden-xs">
          <div class="footer-widget">
            ...
            <div class="widget-content">
              <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FPhone-2H2K-104184915275241%2F&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="270" height="130" style="border: none; overflow: hidden; max-width: 100%;" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
  ...
  <div class="footer-bottom">
    <div class="copyright text-center">
      Copyright &copy 2021 2H2K. All rights reserved.
    </div>
  </div>
</footer>
